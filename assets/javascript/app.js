var topics=["owl","parrot","pigeons","gulls","lark","sparrow","crow","kingfisher","cuckoos","loon","crane","tern"];
...
$("#find-birds").on("click",function(){
	event.preventDefault();	
	var birdName=$("#bird-input").val();
	console.log(birdName);
	topics.push(birdName);	
	console.log(topics);
	renderButtons();
      click();
});
...
function click(){
	var form=document.getElementById("bird-form")
       form.reset();
	}

$(document).on("click","button",function(){
	var bird = $(this).attr("data");
	console.log(bird);
